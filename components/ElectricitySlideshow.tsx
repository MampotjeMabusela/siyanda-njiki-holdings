...
const images = [
  "/images/electricity-1.png",
  "/images/electricity-2.png",
  "/images/electricity-3.png",
  "/images/electricity-4.png",
  "/images/electricity-5.png",
  "/images/electricity-6.png",
];

export default function ElectricitySlideshow() {
  ...
  return (
    <div className="flex h-full min-w-0 flex-col rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
      <h2 className="text-lg font-bold text-primary">Electricity Projects</h2>
      <p className="mt-1 text-xs text-slate-600">
        Recent field work and installations from our electrical team.
      </p>
      <div className="relative mt-3 min-h-0 flex-1 overflow-hidden rounded-lg bg-slate-50">
        ...
        <div className="min-w-0">
          <img
            key={images[current]}
            src={images[current]}
            alt={`Electricity project ${current + 1} of ${images.length}`}
