...
const images = [
  "/images/plumbing-1.png",
  "/images/plumbing-2.png",
  "/images/plumbing-3.png",
  "/images/plumbing-4.png",
  "/images/plumbing-5.png",
  "/images/plumbing-6.png",
];

export default function PlumbingSlideshow() {
  ...
  return (
    <div className="flex h-full min-w-0 flex-col rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
      <h2 className="text-lg font-bold text-primary">Plumbing Projects</h2>
      <p className="mt-1 text-xs text-slate-600">
        Recent plumbing installations, repairs, and maintenance work.
      </p>
